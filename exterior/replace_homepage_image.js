...
const oldImageId = '1600596542815-ffad4c1539a9';
const newImageUrl = 'https://images.unsplash.com/photo-1776784995502-afb418b23d83?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
...
files.forEach(file => {
    ...
    if (modified) {
        ...
        console.log(`Updated Homepage Hero / Facades image in ${file}`);
    }
});
